...
import { fetchProducts, showProductDetails, fetchImages, addToCart} from '../actions'
...
class ProductList extends React.Component {
   ...
   renderList() {
       return this.props.products.map(product =>  {
           return (
                <div className="ui item"  key={this.props.images[`${product.id-1}`].id}>
                    <img 
                        ...
                        <div className="extra">
                            <div className="large ui buttons right floated">
                                <Link to={`/product/${product.id}`}>
                                 ...
                                 <div className="ui animated button" tabIndex="0" onClick={() => this.props.addToCart(product)} >
...
export default connect (mapStateToProps, {fetchProducts, showProductDetails, fetchImages, addToCart})(ProductList);
